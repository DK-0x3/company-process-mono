...
import { Dot, DotConfig } from '@features/scheme-editor/components/dot-arrow/Dot';
...
const DEFAULT_FILL_PROCESS = '#ffffff';
const DEFAULT_COLOR_PROCESS = '#000000';
const DEFAULT_STROKE_COLOR_PROCESS = '#0084ff';
const DEFAULT_STROKE_WIDTH_PROCESS = 2;
const DEFAULT_CORNER_RADIUS_PROCESS = 10;

export interface ProcessComponentConfig extends RectComponentConfig {
	process: Process;
...
export class ProcessComponent extends RectComponent<ProcessComponentConfig> {
	private dots: Dot[] = [];
	...
	constructor(props: ProcessComponentProps) {
		const config: ProcessComponentConfig = {
			...props,
			fill: DEFAULT_FILL_PROCESS,
			color: DEFAULT_COLOR_PROCESS,
			strokeColor: DEFAULT_STROKE_COLOR_PROCESS,
			strokeWidth: DEFAULT_STROKE_WIDTH_PROCESS,
			cornerRadius: DEFAULT_CORNER_RADIUS_PROCESS,
	...
	public getProcess = () => this.configuration.process;

	public setProcess = (process: Process) => {
		this.configuration.process = process;
		this.configuration.title = process.name;
		this.text.text(process.name);
	};
