...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY", "django-insecure-ooa&n@wrb9^^i+da0t27+=$m&s^nyt6a0_yjjtpgzi2kbf*sjw"
)
...
CSRF_TRUSTED_ORIGINS = split_csv(
    os.getenv("DJANGO_CSRF_TRUSTED_ORIGINS", ",".join(default_csrf_origins))
)
...
INSTALLED_APPS = [
    ...
    'smartpoultry.apps.SmartpoultryConfig',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'smartpoultry.context_processors.ui_permissions',
            ],
        },
    },
]
